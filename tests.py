...
class TestUsers(unittest.TestCase):
    ...
    def test_01_add(self):
        rv = self.app.post(
            '/users/add', data=dict(name='test name', email='test@email.com'), follow_redirects=True)
    ...
    def test_02_Update(self):
        ...
        with app.app_context():
            ...
            rv = self.app.post('/users/update/{}'.format(id), data=dict(
                name='test name update', email='test@email.update'), follow_redirects=True)
